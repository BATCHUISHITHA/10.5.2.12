...
&=x(0)[\frac{1 \cdot (z^{-(n+1)}-1) }{z^{-1}-1}] + d[\frac{1}{1-z^{-1}}+ 1\cdot\frac{z^{-1}\cdot (1-z^{n-1})}{1-z^{-1}}-n\cdot z^{n}] \\
&=x(0)[\frac{1 \cdot (z^{-(n+1)}-1) }{z^{-1}-1}] +d[\frac{1+z^{-1}\cdot (1-z^{n-1})}{1-z^{-1}} -n\cdot z^{n}] \\
&=\frac{x(0)\cdot (z^{-(n+1)}-1) -d \cdot (1+z^{-1}\cdot (1-z^{n-1})) }{z^{-1}-1}-n \cdot d \cdot z^{n} \\
&=x(0)(U(z)) + d[-z \cdot \frac {d(U(z))}{dz}] \\
Y(z)&=\frac{y(0)\cdot (z^{-(n+1)}-1) -d \cdot (1+z^{-1}\cdot (1-z^{n-1})) }{z^{-1}-1}-n \cdot d \cdot z^{n} \\
\end{align}
\begin{align}
